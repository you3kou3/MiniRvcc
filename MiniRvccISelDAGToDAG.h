//===---- MiniRvccISelDAGToDAG.h - A dag to dag inst selector for MiniRvcc ------===//
//
...
#ifndef LLVM_LIB_TARGET_MINIRVCC_MINIRVCCISELDAGTODAG_H
#define LLVM_LIB_TARGET_MINIRVCC_MINIRVCCISELDAGTODAG_H

#include "MiniRvcc.h"
#include "MiniRvccTargetMachine.h"
#include "llvm/CodeGen/SelectionDAGISel.h"

// MiniRvcc-specific code to select MiniRvcc machine instructions for
// SelectionDAG operations.
namespace llvm {
class MiniRvccDAGToDAGISel : public SelectionDAGISel {
    const MiniRvccSubtarget *Subtarget = nullptr;

public:
    explicit MiniRvccDAGToDAGISel(MiniRvccTargetMachine &TargetMachine,
                                  CodeGenOpt::Level OptLevel)
        : SelectionDAGISel(TargetMachine, OptLevel) {}

    StringRef getPassName() const override {
        return "MiniRvcc DAG->DAG Pattern Instruction Selection";
    }

    bool runOnMachineFunction(MachineFunction &MF) override {
        Subtarget = &MF.getSubtarget<MiniRvccSubtarget>();
    ...
    static MiniRvccCC::CondCode getMiniRvccCCForIntCC(ISD::CondCode CC) {
        switch (CC) {
        default:
            llvm_unreachable("Unsupported CondCode");
        case ISD::SETEQ: return MiniRvccCC::COND_EQ;
        case ISD::SETNE: return MiniRvccCC::COND_NE;
        case ISD::SETLT: return MiniRvccCC::COND_LT;
        case ISD::SETGE: return MiniRvccCC::COND_GE;
        case ISD::SETULT: return MiniRvccCC::COND_LTU;
        case ISD::SETUGE: return MiniRvccCC::COND_GEU;
        }
    }

    // Include the pieces autogenerated from the target description.
    #include "MiniRvccGenDAGISel.inc"
