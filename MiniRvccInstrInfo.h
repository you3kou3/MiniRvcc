//===-- MiniRvccInstrInfo.h - MiniRvcc Instruction Information --------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_MINIRVCC_MINIRVCCINSTRINFO_H
#define LLVM_LIB_TARGET_MINIRVCC_MINIRVCCINSTRINFO_H
...
} // end of namespace MiniRvccCC


class MiniRvccInstrInfo : public MiniRvccGenInstrInfo {

public:
   explicit MiniRvccInstrInfo(MiniRvccSubtarget &STI);

   //MCInst getNop() const override;
   const MCInstrDesc &getBrCond(MiniRvccCC::CondCode CC) const;
   ...
   std::string
   createMIROperandComment(const MachineInstr &MI, 
                           const MachineOperand &Op,
                           unsigned OpIdx,
                           const TargetRegisterInfo *TRI) const override;

   Register getVLENFactoredAmount(MachineFunction &MF, 
                                  MachineBasicBlock &MBB,
...
// Implemented in MiniRvccGenInstrInfo.inc
...
#define GET_MiniRvccVPseudosTable_DECL
#include "MiniRvccGenSearchableTables.inc"

} // end namespace MiniRvccVPseudosTable
